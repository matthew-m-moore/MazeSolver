...
{
    [TestClass]
    public class WallHuggingDirectionPickerTests
    {
        ...
        [TestMethod, Owner("Matthew Moore")]
        public void PickDirectionToProceed_CanProceedInAnyDirectionAndLeftIsWallAdjacent_PicksDirectionLeft()
        {
            var currentMazeGridpoint =
                new MazeGridpoint(new CartesianCoordinate(2, 2), new DirectionsAvailable(), false, false, false);
        ...
        [TestMethod, Owner("Matthew Moore")]
        public void PickDirectionToProceed_CannotProceedInDirectionUpOrDownAndRightIsWallAdjacent_PicksDirectionRight()
        {
            var currentMazeGridpoint =
                new MazeGridpoint(new CartesianCoordinate(2, 2), new DirectionsAvailable(), false, false, false);
            ...
            var listOfMazeGridpoints = new List<MazeGridpoint>
            {
                ...
                new MazeGridpoint(new CartesianCoordinate(  4 ,  2), new DirectionsAvailable(), false, false,  true),
                new MazeGridpoint(new CartesianCoordinate(  2 ,  4), new DirectionsAvailable(), false,  true, false)
            };
